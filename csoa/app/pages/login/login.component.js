...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.userService.login(this.user)
            .subscribe(function () { _this.router.navigate(["/list"]); }, function (error) { alert("Unfortunately we coud not find your account."); });
    };
